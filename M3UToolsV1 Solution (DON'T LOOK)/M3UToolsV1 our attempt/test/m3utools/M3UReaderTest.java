...
public class M3UReaderTest {
    ...
    public void testHasType() {
        System.out.println("has type test 1");
        assertEquals(true, M3UReader.hasType("test-data/testCopy/inputPlaylist.m3u", "mp3"));
        System.out.println("has type test 2");
        assertEquals(true, M3UReader.hasType("test-data/testCopy/inputPlaylist.m3u", "MP3"));
        System.out.println("has type test 3");
        assertEquals(false, M3UReader.hasType("test-data/testCopy/inputPlaylist.m3u", "mp4"));
        System.out.println("has type test 4");
        assertEquals(false, M3UReader.hasType("sillyfile/not/here", "mp3"));
        System.out.println("has type test 5");
        assertEquals(false, M3UReader.hasType(":% * invalid* ", "mp3"));
