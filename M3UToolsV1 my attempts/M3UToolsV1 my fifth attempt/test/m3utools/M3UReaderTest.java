...
public class M3UReaderTest {
    ...
    public void testHasType() {
        ...
        boolean result = M3UReader.hasType("test-data/testCopy/inputPlaylist.m3u", "mp3");
        assertEquals(true, result);
        boolean result2 = M3UReader.hasType("test-data/testCopy/inputPlaylist.m3u", "MP3");
        assertEquals(true, result2);
        boolean result3 = M3UReader.hasType("test-data/testCopy/inputPlaylist.m3u", "mp4");
        assertEquals(false, result3);
        boolean result4 = M3UReader.hasType("blah/nofile", "wav");
