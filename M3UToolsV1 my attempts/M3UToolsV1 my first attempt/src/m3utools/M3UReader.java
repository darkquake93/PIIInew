...
public class M3UReader {
    ...
    public static boolean hasEmptyLines(String playlistFilename) {

        File inputFile = new File(playlistFilename);
        try {
    ...
    public static List<String> getExtraComments(String playlistFilename) {
    ...
    public static boolean hasExtraComments(String playlistFilename) {
        File file = new File(playlistFilename);
        try {
            ...
            while ((line = br2.readLine()) != null) {
                ...
                if (line.startsWith("#EXTM3U") && (br2.readLine().startsWith("#") && !(br2.readLine().startsWith("#EXTINF")))) {
                    System.out.println("First line: " + line);
                    System.out.println("Has comments after this line");
                    System.out.println("Returning true");
                    return true;
                } else {
                    System.out.println("First line: " + line);
                    System.out.println("Does not have comments after this line: " + line);
            ...
            System.out.println("Returning false, Exception: " + ex);
            return false;
        }
        System.out.println("Returning false: Other error");
        return false;
    }

    public static boolean hasType(String playlistFilename, String ext) {
        File file = new File(playlistFilename);
        try {
            ...
            String line;
            while ((line = br.readLine()) != null) {
                if (line.toLowerCase().endsWith(ext.toLowerCase())) {
                    return true;
                }
            }
            br.close();
    ...
    public static M3UTrack getTrack(String trackFilename, String trackMetaData) {
        ...
        if (start != -1 && end != -1) {
            ...
            artistName = trackMetaData.substring(end + 1);
            trackName = trackMetaData.substring(end + 1);
        }

        M3UTrack trackToReturn = new M3UTrack();
        trackToReturn.setTrackFilename(trackFilename);
        trackToReturn.setArtistName(artistName);
        trackToReturn.setTrackName(trackName);
        trackToReturn.setTrackDuration(seconds);
